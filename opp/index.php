...
<meta name="viewport" content="width=device-width, initial-scale=1">
      <table class="striped" id="table">
          <thead>
            <th style=min-width:50px>Bus Number</th>
            <th style=min-width:50px>Time (1st)</th>
            <th style=min-width:50px>Features (1st)</th>
            <th style=min-width:50px>Time (2nd)</th>
            <th style=min-width:50px>Features (2nd)</th>
            <th style=min-width:50px>Location (1st)</th>
          </thead><tr>
<?php
